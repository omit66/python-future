...
class Test_xrange(FixerTestCase):
    ...
    def test_in_consuming_context(self):
        for call in fixer_util.consuming_calls:
            ...
            self.check(a, b)
            a = "a = %s(range(10))" % call
            b = "import past.builtins\na = %s(past.builtins.range(10))" % call
            self.check(a, b)

    def test_range_in_for(self):
        a = "for i in range(9): pass"
        b = "import past.builtins\nfor i in past.builtins.range(9): pass"
        self.check(a, b)
        c = "[i for i in range(9)]"
        d = "import past.builtins\n[i for i in past.builtins.range(9)]"
        self.check(c, d)
    ...
    def test_range_prefix_preservation(self):
        b = """x =    range(  10  )"""
        a = """import past.builtins\nx =    past.builtins.range(  10  )"""
        self.check(b, a)

        b = """x = range(  1  ,  10   )"""
        a = """import past.builtins\nx = past.builtins.range(  1  ,  10   )"""
        self.check(b, a)

        b = """x = range(  0  ,  10 ,  2 )"""
        a = """import past.builtins\n"""\
            """x = past.builtins.range(  0  ,  10 ,  2 )"""
        self.check(b, a)
